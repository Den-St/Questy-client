...
import { AnswerContainer, AnswersContainer, AnswerText, Question,Date, NoAnswers, QuestionTitle } from "../Answers/styles";
...
export const CorrectAnswers:React.FC<Props> = ({answers,loading}) => {
